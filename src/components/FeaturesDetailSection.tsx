...
const features = [
  {
    ...
    description: 'Sistema completo onde o aluno visualiza os horários disponíveis e agenda diretamente. Sem ligações, sem mensagens perdidas.',
    highlights: [
      {
        icon: Bell,
  ...
  },
  {
    ...
    description: 'Painel de controle onde você registra o desenvolvimento técnico do aluno após cada aula, criando um histórico completo.',
    highlights: [
      {
        icon: ClipboardCheck,
        text: 'Registre: embreagem, retrovisores, baliza e mais',
      },
      {
        icon: BarChart3,
  ...
  },
  {
    ...
    description: 'Ferramenta de avaliação em tempo real durante a aula, seguindo os critérios oficiais do DETRAN para o exame prático.',
    highlights: [
      {
        icon: ClipboardCheck,
      ...
      <div className="container mx-auto px-4">
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <p className="text-muted-foreground text-lg">
            Ferramentas profissionais para elevar sua qualidade de ensino
          </p>
        </div>
                ...
                <div className="space-y-3 pt-2">
                  {feature.highlights.map((highlight, i) => (
                    <div key={i} className="flex items-center gap-3 bg-card rounded-xl p-4 border border-border">
                      <div className={`${feature.iconBg} w-10 h-10 rounded-lg flex items-center justify-center flex-shrink-0`}>
